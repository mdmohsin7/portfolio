...
summary: "I was staring at a packet capture, trying to figure out why my script wasn't receiving audio data.\nThe device was clearly working. LED on. App showing audio levels. But when I subscribed to the audio characteristic—the standard approach for every BLE..."
