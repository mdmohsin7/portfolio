...
j.i(m)
T.D(m,"I'm a 21 year old software developer and a Blockchain enthusiast. I love making high quality mobile apps using Flutter and websites with the usual frontend stack. Currently exploring GO and the Cosmos SDK. On a journey to become a full stack developer.")
l=T.r(h,q)
j.k(l,"cv-button")
j.i(l)
k=T.n(h,l,"a")
T.z(k,"href","https://drive.google.com/file/d/1J4k1ZO4sUQPgO4TrKImccJHWHbICyT5x/view")
